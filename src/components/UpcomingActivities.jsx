      ...
      <div>
        ...
        <div className="aspect-video w-full mb-4 overflow-hidden rounded-lg">
          {imageSrc ? (
            ...
            <div className="w-full h-full flex items-center justify-center bg-gray-200 text-gray-400 font-semibold text-lg">
              {isEnglish ? 'No Image' : 'ಯಾವುದೇ ಚಿತ್ರವಿಲ್ಲ'}
            </div>
          )}
        </div>
...
const UpcomingActivities = () => {
  ...
  return (
    <section className="w-full py-12 overflow-hidden">
      ...
      >
        {(() => {
          const pdfFileName = 'ಕೇಂದ್ರ ಕಾರ್ಯಕಾರಿ ಸಮಿತಿ ಸದಸ್ಯರನ್ನಾಗಿ ನೇಮಕ ಮಾಡುವ ಕುರಿತು..pdf';
          const pdfUrl = `/assets/${encodeURIComponent(pdfFileName)}`;
          const displayTitle = isEnglish ? 'Executive Committee Appointment Notification (PDF)' : pdfFileName;
          return (
            <div className="w-[350px] mb-2 p-4 pb-8 mx-4 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 h-[500px] flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-bold text-gray-800 mb-3">{displayTitle}</h3>
...
// // Import the PDF files from assets
// import hostelGoEnglishPdf from '../../';
// import hostelGoKannadaPdf from '../../assets/management-seats-hostel-go-kannada.pdf';

// const ActivityCard = ({
//   title, k_title, program_date, location, k_location,
//   program_time, about, k_about, media_file, id, isEnglish
// }) => {
//   const navigate = useNavigate();
...
//   let imageAlt = isEnglish ? title : k_title;
//   if (Array.isArray(media_file) && media_file.length > 0) {
//     const firstImage = media_file.find(media =>
...
//         {isEnglish ? "Notifications/Programs" : "ಮಹಾಸಭಾದ ಅಧಿಸೂಚನೆಗಳು/ಕಾರ್ಯಕ್ರಮಗಳು"}
//       </h2>

//       {/* PDF Download Buttons */}
//       <div className="max-w-7xl mx-auto mb-8 px-4 flex flex-col md:flex-row gap-4 justify-center">
//         <a
//           href={hostelGoEnglishPdf}
//           download="Management_Seats_Hostel_GO.pdf"
//           className="bg-green-600 text-white rounded px-4 py-2 no-underline shadow hover:bg-green-700 transition"
//         >
//           Management Seats hostel GO (English)
//         </a>
//         <a
//           href={hostelGoKannadaPdf}
//           download="ಹಾಸ್ಟೆಲ್_ನಿರ್ವಹಣೆ_ಸೀಟುಗಳು_GO.pdf"
//           className="bg-green-600 text-white rounded px-4 py-2 no-underline shadow hover:bg-green-700 transition"
//         >
//           ಹಾಸ್ಟೆಲ್ ನಿರ್ವಹಣೆ ಸೀಟುಗಳು GO (Kannada)
//         </a>
//       </div>
