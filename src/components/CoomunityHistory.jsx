...
// //           <img
// //   className="rounded-xl shadow-lg object-cover w-full max-h-[600px]"
// //   src="assets/culture_new_1.jpeg" // Change this path to your image
// //   alt={isEnglish ? "Community History" : "ಸಮುದಾಯದ ಇತಿಹಾಸ"}
// //   style={{ height: '70%', maxHeight: '600px' , width: '70%' }}
// // />
...
//         <div className="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
...
//           {/* Single Image Section - above text on mobile, right on desktop */}
