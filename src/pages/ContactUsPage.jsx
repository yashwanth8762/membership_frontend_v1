    ...
    <>
      <section id="contact-us" className="bg-gradient-to-br from-gray-50 to-blue-50 py-12 lg:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mb-10 lg:mb-12">
            {/* Back Button */}
            <button
              className="mb-4 sm:mb-0 px-6 py-2 bg-blue-600 text-white rounded-full font-semibold shadow hover:bg-blue-700 transition-all duration-300 self-start flex items-center gap-3 cursor-pointer"
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    {user.language ?  <p className="text-gray-900 font-medium">
                      Karnataka Madara Mahasabha<br />
                      # 39/A, 1st Floor, near Shivananda Circle,<br />
                      Kumara Park East, Seshadripuram,<br />
                      Bengaluru, Karnataka 560001
                    </p>:<p className="text-gray-900 font-medium">
                      ಕರ್ನಾಟಕ ಮಾದಾರ ಮಹಾಸಭಾ
                      # 39/A, 1 ನೇ ಮಹಡಿ, ಶಿವಾನಂದ ಸರ್ಕಲ್ ಹತ್ತಿರ,
                      ಕುಮಾರ ಪಾರ್ಕ್ ಪೂರ್ವ, ಶೇಷಾದ್ರಿಪುರಂ,
