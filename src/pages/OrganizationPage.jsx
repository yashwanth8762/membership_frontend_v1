...
import {
  organizationTalukMembers,
  organizationDistrictMembers,
...
const OrganizationPage = () => {
  ...
  return (
    <>
      <section>
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-center min-h-[80vh] text-justify">
          {/* Back Button */}
          <button
...
<p className="text-center text-gray-600 mt-0">
  {isEnglish ? "(Based on the population of the Madara/Madiga community in each District)" : ""}
          ...
          <div className="w-full max-w-4xl mx-auto mb-10">
            {OrganizationContent.first_otherhalf[
              isEnglish ? "paragraph_en" : "paragraph_kn"
            ].map((para, idx) => (
              <p
                key={idx}
              ...
              <div key={idx} className="mb-10">
                ...
                <div className="space-y-4 text-lg text-gray-700">
                  {section.items.map((item, i) => {
                    const textBlock = isEnglish ? item.en : item.kn;
                    const title = item[isEnglish ? "title_en" : "title_kn"];
                    ...
                    return (
                      <div key={i} className="mb-3">
                        ...
                        {textBlock.includes("\n") ? (
                          ...
                          <p className="leading-relaxed">{textBlock}</p>
                        )}
                      </div>
                    );
                  })}
