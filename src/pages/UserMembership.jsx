...
//       500: { 
//         name: isEnglish ? 'General Membership' : 'ಸಾಮಾನ್ಯ ಸದಸ್ಯತ್ವ', 
//         color: '#3b82f6', // Blue
//         bgColor: '#dbeafe'
//       },
//       5000: { 
//         name: isEnglish ? 'Special Membership' : 'ವಿಶೇಷ ಸದಸ್ಯತ್ವ', 
//         color: '#10b981', // Green
//         bgColor: '#d1fae5'
//       },
//       10000: { 
//         name: isEnglish ? 'Premium Membership' : 'ಪ್ರೀಮಿಯಂ ಸದಸ್ಯತ್ವ', 
//         color: '#d97706', // Bronze
//         bgColor: '#fef3c7'
//       },
//       25000: { 
//         name: isEnglish ? 'Lifetime Membership' : 'ಆಜೀವ ಸದಸ್ಯತ್ವ', 
//         color: '#64748b', // Silver
//         bgColor: '#f1f5f9'
//       },
//       50000: { 
//         name: isEnglish ? 'Poshaka Membership' : 'ಪೋಷಕ ಸದಾಶತ್ವ', 
//         color: '#eab308', // Gold
//         bgColor: '#fef3c7'
//       },
//       100000: { 
//         name: isEnglish ? 'Mahaposhaka Sadasatva' : 'ಮಹಾಪೋಷಕ ಸದಾಶತ್ವ', 
//         color: '#9ca3af', // Platinum
//         bgColor: '#f9fafb'
//       },
//       // 500000: { 
//       //   name: isEnglish ? 'Premium Gold Membership' : 'ಪ್ರೀಮಿಯಂ ಚಿನ್ನದ ಸದಸ್ಯತ್ವ', 
...
//             marginBottom: 40,
//           }}>
//             ಕರ್ನಾಟಕ ರಾಜ್ಯದ ವಿವಿಧ ಜಿಲ್ಲೆ ಮತ್ತು ತಾಲೂಕುಗಳಿಂದ ಕನಿಷ್ಠ 18 ವರ್ಷ ವಯಸ್ಸು ತುಂಬಿದ ಮಾದರ/ಮಾದಿಗ ಜನಾಂಗದ ಪುರುಷರು ಮತ್ತು ಮಹಿಳೆಯರು ಕರ್ನಾಟಕ ಮಾದರ ಮಹಾಸಭಾಗೆ ಸದಸ್ಯರಾಗಲು ಅರ್ಹರಾಗಿರುತ್ತಾರೆ. ಸದಸ್ಯರಾಗಲು ಇಚ್ಚಿಸುವ ತಾಲೂಕು ಮತ್ತು ಜಿಲ್ಲಾ ನಿವಾಸಿಗಳು ಸಭಾದ ಕಾರ್ಯಕಾರಿ ಸಮಿತಿ ನಿಗಧಿಪಡಿಸಿದ ಅರ್ಜಿ ನಮೂನೆಯಲ್ಲಿ ವಿವರಗಳನ್ನು ತುಂಬಿ ನಿಗಧಿ ಪಡಿಸಿದ ಶುಲ್ಕ ಪಾವತಿಸಬೇಕಾಗಿರುತ್ತದೆ. ಅರ್ಜಿ ನಮೂನೆ ಮತ್ತು ಪಾವತಿ ವಿವರಗಳು ಕೆಳಕಂಡಂತಿದ್ದು, ಆನ್‌ಲೈನ್‌ ಮೂಲಕ ಅರ್ಜಿ ಸಲ್ಲಿಸಿ ಶುಲ್ಕ ಪಾವತಿಸಿ ಸದಸ್ಯತ್ವ ಪಡೆಯಬಹುದಾಗಿದೆ ಹಾಗೂ ಮೆಂಬರ್‌ಶಿಪ್‌ ಕಾರ್ಡ್‌ನ್ನು ಡೌನ್‌ಲೋಡ್‌ ಮಾಡಿಕೊಳ್ಳಬಹುದಾಗಿದೆ.
//             ಕರ್ನಾಟಕ ರಾಜ್ಯದ ವಿವಿಧ ಜಿಲ್ಲೆ ಮತ್ತು ತಾಲೂಕುಗಳಿಂದ ಕನಿಷ್ಠ 18 ವರ್ಷ ವಯಸ್ಸು ತುಂಬಿದ ಮಾದರ/ಮಾದಿಗ ಜನಾಂಗದ ಪುರುಷರು ಮತ್ತು ಮಹಿಳೆಯರು ಕರ್ನಾಟಕ ಮಾದರ ಮಹಾಸಭಾಗೆ ಸದಸ್ಯರಾಗಲು ಅರ್ಹರಾಗಿರುತ್ತಾರೆ. ಸದಸ್ಯರಾಗಲು ಇಚ್ಚಿಸುವ ತಾಲೂಕು ಮತ್ತು ಜಿಲ್ಲಾ ನಿವಾಸಿಗಳು ಸಭಾದ ಕಾರ್ಯಕಾರಿ ಸಮಿತಿ ನಿಗಧಿಪಡಿಸಿದ ಅರ್ಜಿ ನಮೂನೆಯಲ್ಲಿ ವಿವರಗಳನ್ನು ತುಂಬಿ ನಿಗಧಿ ಪಡಿಸಿದ ಶುಲ್ಕ ಪಾವತಿಸಬೇಕಾಗಿರುತ್ತದೆ. ಅರ್ಜಿ ನಮೂನೆ ಮತ್ತು ಪಾವತಿ ವಿವರಗಳು ಕೆಳಕಂಡಂತಿದ್ದು, ಆನ್‌ಲೈನ್‌ ಮೂಲಕ ಅರ್ಜಿ ಸಲ್ಲಿಸಿ ಶುಲ್ಕ ಪಾವತಿಸಿ ಸದಸ್ಯತ್ವ ಪಡೆಯಬಹುದಾಗಿದೆ ಹಾಗೂ ಮೆಂಬರ್‌ಶಿಪ್‌ ಕಾರ್ಡ್‌ನ್ನು ಡೌನ್‌ಲೋಡ್‌ ಮಾಡಿಕೊಳ್ಳಬಹುದಾಗಿದೆ.
//           </div>
//           <button
...
//                     <option value="5000">₹5,000 - {isEnglish ? 'Special membership' : 'ವಿಶೇಷ ಸದಸ್ಯತ್ವ  '}</option>
//                     <option value="10000">₹10,000 - {isEnglish ? 'Special membership' : 'ವಿಶೇಷ ಸದಸ್ಯತ್ವ  '}</option>
...
//                     {/* <option value="500000">₹5,00,000 - {isEnglish ? 'Premium Gold Membership' : 'ಪ್ರೀಮಿಯಂ ಚಿನ್ನದ ಸದಸ್ಯತ್ವ'}</option> */}
                    
//                   </select>
//                 </div>
                
//                 {/* Membership Type Indicator */}
//                 {values['Membership Amount'] && (
//                   <div className="col-span-full mb-4">
//                     {(() => {
//                       const typeInfo = getMembershipTypeInfo(parseInt(values['Membership Amount']));
//                       if (typeInfo) {
//                         return (
//                           <div 
...
//                               boxShadow: `0 2px 8px ${typeInfo.color}20`
//                             }}
//                           >
...
//                               </span>
//                             </div>
//                             <div className="text-sm mt-1 font-medium" style={{ color: typeInfo.color }}>
//                               {isEnglish ? 'Your membership card will have this color theme' : 'ನಿಮ್ಮ ಸದಸ್ಯತ್ವ ಕಾರ್ಡ್ ಈ ಬಣ್ಣದ ಥೀಮ್ ಅನ್ನು ಹೊಂದಿರುತ್ತದೆ'}
//                             </div>
//                           </div>
//                         );
//                       }
...
//                         {isEnglish ? 'Loading districts...' : 'ಜಿಲ್ಲೆಗಳನ್ನು ಲೋಡ್ ಮಾಡುತ್ತಿದೆ...'}
//                       </div>
//                     )}
//                   </div>
...
//                       className="w-full p-2.5 rounded-lg border border-slate-300 text-base bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-400"
//                     >
//                       <option value="">{isEnglish ? 'Select taluk...' : 'ತಾಲೂಕು ಆಯ್ಕೆಮಾಡಿ...'}</option>
//                       {taluks.map((taluk) => (
//                         <option key={taluk.id || taluk._id} value={taluk.id || taluk._id}>
...
//                     {loadingTaluks && (
//                       <div className="text-sm text-blue-600 mt-1">
//                         {isEnglish ? 'Loading taluks...' : 'ತಾಲೂಕುಗಳನ್ನು ಲೋಡ್ ಮಾಡುತ್ತಿದೆ...'}
//                       </div>
//                     )}
//                     {!selectedDistrict && (
//                       <div className="text-sm text-gray-500 mt-1">
//                         {isEnglish ? 'Please select a district first' : 'ದಯವಿಟ್ಟು ಮೊದಲು ಜಿಲ್ಲೆಯನ್ನು ಆಯ್ಕೆಮಾಡಿ'}
//                       </div>
//                     )}
//                   </div>
//                 </div>
...
//                   {/* Debug button removed to fix JSX errors */}
//                   <button
//                     type="submit"
//                     style={{
//                       padding: '12px 32px',
            ...
            {!membershipId && form && (
              <form onSubmit={handleSubmit} style={{ maxWidth: 600, margin: '0 auto' }}>
                ...
                <div className="col-span-full mb-6">
                  ...
                  >
                    <span style={{ fontWeight: 700, color: '#4338ca', fontSize: '1.1rem', display: 'block', marginBottom: '8px' }}>ಸೂಚನೆ:</span>
