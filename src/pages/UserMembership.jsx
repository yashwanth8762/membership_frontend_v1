...
//             }}
//           >
//             ಕರ್ನಾಟಕ ರಾಜ್ಯದ ವಿವಿಧ ಜಿಲ್ಲೆ ಮತ್ತು ತಾಲ್ಲೂಕುಗಳಿಂದ ಕನಿಷ್ಠ 18 ವರ್ಷ ವಯಸ್ಸು
//             ತುಂಬಿದ ಮಾದರ / ಮಾದಿಗ ಜನಾಂಗದ ಪುರುಷರು ಮತ್ತು ಮಹಿಳೆಯರು ಕರ್ನಾಟಕ ಮಾದರ
//             ಮಹಾಸಭಾಗೆ ಸದಸ್ಯರಾಗಲು ಅರ್ಹರಾಗಿರುತ್ತಾರೆ. ಸದಸ್ಯರಾಗಲು ಇಚ್ಛಿಸುವ
//             ತಾಲ್ಲೂಕು ಮತ್ತು ಜಿಲ್ಲಾ ನಿವಾಸಿಗಳು ಸಭಾದ ಕಾರ್ಯಕಾರಿ ಸಮಿತಿ ನಿಗಧಿಪಡಿಸಿದ ಅರ್ಜಿ
//             ನಮೂನೆಯಲ್ಲಿ ವಿವರಗಳನ್ನು ತುಂಬಿ ನಿಗಧಿ ಪಡಿಸಿದ ಶುಲ್ಕ ಪಾವತಿಸಬೇಕಾಗಿರುತ್ತದೆ.
//             ಅರ್ಜಿ ನಮೂನೆ ಮತ್ತು ಪಾವತಿ ವಿವರಗಳು ಕೆಳಕಂಡಂತಿದ್ದು, ಆನ್‌ಲೈನ್‌ ಮೂಲಕ ಅರ್ಜಿ
//             ಸಲ್ಲಿಸಿ ಶುಲ್ಕ ಪಾವತಿಸಿ ಸದಸ್ಯತ್ವ ಪಡೆಯಬಹುದಾಗಿದೆ ಹಾಗೂ ಮೆಂಬರ್‌ಶಿಪ್‌ ಕಾರ್ಡ್
...
//           >
//             Men and Women belonging to the Madara / Madiga community from various
//             Districts and Taluks of Karnataka, who are at least 18 years of age, are
//             eligible to become members of the Karnataka Madara Mahasabha. Residents of
//             the respective Taluk and District who wish to become members must fill in
//             the details in the prescribed application form determined by the Executive
//             Committee of the Mahasabha and pay the prescribed membership fee.
//           </div>
//           <button
//             onClick={() => setShowForm(true)}
//             style={{
...
//                     <ol style={{ paddingLeft: "1.2em", margin: 0, listStyleType: "decimal" }}>
//                       <li style={{ marginBottom: "6px" }}>
//                         ಸಮಾನ್ಯ , ವಿಶೇಷ ಮತ್ತು ಪ್ರೀಮಿಯಂ ಸದಸ್ಯತ್ವ ಹೊಂದಿರುವರು ಜಿಲ್ಲ /ತಾಲ್ಲೂಕ
//                         ಮಟ್ಟದ ಪದಾಧಿಕಾರಿಗಳ ಚುನಾವಣೆಗೆ ಮಾತ್ರ ಸ್ಪರ್ಧೀಸಲು ಅವಕಾಶವಿರುತ್ತದೆ.
//                       </li>
//                       <li>
//                         ಅಜೀವ, ಪೋಷಕ ಮತ್ತು ಮಹಾ ಪೋಷಕ ಸದಸ್ಯತ್ವ ಹೊಂದಿರುವರು ಮಾತ್ರ ರಾಜ್ಯ
//                         ಮಟ್ಟದ ಪದಾಧಿಕಾರಿಗಳ ಚುನಾವಣೆಗೆ ಸ್ಪರ್ಧಿಸಲು ಆರ್ಹರಿರುತ್ತಾರೆ.
//                       </li>
//                     </ol>
...
//                   >
//                     <option value="">Select amount...</option>
//                     <option value="500">₹500 - ಸಾಮಾನ್ಯ ಸದಸ್ಯತ್ವ/General Membership</option>
//                     <option value="1000">₹5,000 - ವಿಶೇಷ ಸದಸ್ಯತ್ವ/Special membership</option>
//                     <option value="5000">₹10,000 - ಪ್ರೀಮಿಯಂ ಸದಸ್ಯತ್ವ/Premium membership</option>
//                     <option value="25000">₹25,000 - ಆಜೀವ ಸದಸ್ಯತ್ವ/Lifetime Membership</option>
//                     <option value="50000">₹50,000 - ಪ್ಯಾಟ್ರಾನ್ ಸದಸ್ಯತ್ವ/Patron Membership</option>
//                     <option value="100000">₹1,00,000 - ಮುಖ್ಯ ಪ್ಯಾಟ್ರಾನ್ ಸದಸ್ಯತ್ವ/Chief Patron Membership</option>
//                   </select>
//                 </div>
...
//               </form>
//             )}
//             {/* No membership card or loading UI shown */}
//             {fetchingMembershipData && (
//               <div style={{ textAlign: "center", margin: "2rem auto" }}>
//                 <div>Loading membership card...</div>
//               </div>
