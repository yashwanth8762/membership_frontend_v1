            ...
            {!membershipId && form && (
              <form onSubmit={handleSubmit} style={{ maxWidth: 600, margin: '0 auto' }}>
                ...
                <div className="grid grid-cols-1 mt-4 sm:grid-cols-2 gap-x-6 gap-y-4 mb-4">
                  ...
                  <div className="col-span-1">
                    <label className="block font-medium text-gray-700 mb-2">
                    ತಾಲ್ಲೂಕನ್ನು ಆಯ್ಕೆಮಾಡಿ/Select Taluk <span style={{ color: '#e11d48', marginLeft: 4 }}>*</span>
                    </label>
                    <select
                      value={selectedTaluk}
                      onChange={e => setSelectedTaluk(e.target.value)}
...
<span style={{ fontWeight: 700, color: '#4338ca', fontSize: '1.1rem', display: 'block', marginBottom: '10px' }}>ಸೂಚನೆ:</span>
                ...
                <div className="col-span-full mb-4">
                  <label className="block font-medium text-gray-700 mb-2">
                  ಸದಸ್ಯತ್ವ ಮೊತ್ತವನ್ನು ಆಯ್ಕೆಮಾಡಿ/Select Membership Amount <span style={{ color: '#e11d48', marginLeft: 4 }}>*</span>
                  </label>
                  <select
                    value={values['Membership Amount'] || ''}
                    onChange={e => setValues(v => ({ ...v, 'Membership Amount': e.target.value }))}
