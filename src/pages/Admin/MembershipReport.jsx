...
export default function MembershipReport() {
  ...
  // Helper to wait for all images inside the cardRef to load before capture
  const waitForImagesToLoad = (container) => {
    ...
    images.forEach((img) => {
      ...
      promises.push(new Promise((res, rej) => {
        img.onload = res;
        img.onerror = res; // resolve anyway to not block forever
      }));
    });
  ...
  const handleDownload = async () => {
    ...
    // Give a slight delay to ensure all async rendering settled
