import{e as Q,g as Y,r as $,a as F,u as ee,s as te,j as e,d as ne,c as U,b as re}from"./index-D07VyQ7N.js";var A={},T;function ae(){if(T)return A;T=1;function d(s){if(typeof window>"u")return;const r=document.createElement("style");return r.setAttribute("type","text/css"),r.innerHTML=s,document.head.appendChild(r),s}Object.defineProperty(A,"__esModule",{value:!0});var t=Q();function m(s){return s&&typeof s=="object"&&"default"in s?s:{default:s}}var a=m(t);d(`.rfm-marquee-container {
  overflow-x: hidden;
  display: flex;
  flex-direction: row;
  position: relative;
